...
import com.searchbox.framework.oppfin.CordisCollection;
import com.searchbox.framework.oppfin.EENCollection;
import com.searchbox.framework.oppfin.IdealISTCollection;
import com.searchbox.framework.oppfin.TopicCollection;
  ...
  public void doBootStrap() {
    ...
    if (defaultData) {
      ...
      try {
        ...
        String className = env.getProperty("searchengine.class",
            EmbeddedSolr.class.getName());
        Class<SearchEngine<?, ?>> clazz = (Class<SearchEngine<?, ?>>) Class
            .forName(className);
        engine = new SearchEngineEntity<>().setClazz(clazz).setAttribute(
            env.getProperty("searchengine.prop", "solrHome"),
      ...
      UserEntity system = userService.registerNewUserAccount(
          "system@searchbox.com", "password");
      UserEntity admin = userService.registerNewUserAccount(
          "admin@searchbox.com", "password");
      UserEntity user = userService.registerNewUserAccount(
          "user@searchbox.com", "password");
      ...
      userRepository
          .save(new UserEntity()
              ...
              .setRoles(
                  Arrays
                      .asList(new Role[] { Role.ADMIN, Role.SYSTEM, Role.USER })));
      ...
      CollectionEntity<?> topicsCollection = new CollectionEntity<>()
          .setClazz(TopicCollection.class).setName("H2020Topics")
          .setAutoStart(false).setIdFieldName("topicIdentifier")
      ...
      CollectionEntity<?> eenCollection = new CollectionEntity<>()
          .setClazz(EENCollection.class).setName("eenCooperations")
          .setAutoStart(false).setIdFieldName("eenReferenceExternal")
          .setSearchEngine(engine);
      ...
      CollectionEntity<?> idealistCollection = new CollectionEntity<>()
          .setClazz(IdealISTCollection.class).setName("idealistCooperations")
          .setSearchEngine(engine).setAutoStart(false).setIdFieldName("uid");
      ...
      CollectionEntity<?> cordisCollection = new CollectionEntity<>()
          .setClazz(CordisCollection.class).setIdFieldName("cordisId")
          .setName("fundedProjects").setAutoStart(false)
          .setSearchEngine(engine);
      ...
      searchbox
          ...
          /**
           * Ideally this is a range facet. We agreed that for now it will be a
           * list of months For instance(March 14, April 14, May 14, June 14,
           * ...)
           */
          .newSearchElement()
          .setClazz(FieldFacet.class)
          ...
          .setCollection(
              collectionRepository.save(new CollectionEntity<>()
                  ...
                  .setAttribute(
                      "collections",
                      Arrays.asList(new String[] { eenCollection.getName(),
                          idealistCollection.getName() }))))
          ...
          .newTemplateElement("eenContentTitle",
          ...
          .setAttribute(
              "values",
              new TreeSet<FieldSort.Value>(Arrays.asList(new FieldSort.Value[] {
                  FieldSort.getRelevancySort(),
                  new FieldSort.Value("Newest first", "eenDatumUpdate",
                      Sort.DESC) })))
          .end()
          ...
          // .addFieldCondition("Open Opportunities Only",
          // "idealistStatus","Open")
          ...
          .addQueryElement()
          .addStatElement()
          .newTemplateElement("idealistTitle",
          ...
          .newTemplateElement("cordisTitle",
          ...
          .addPagingElement().addDebugElement().endChild().end();
    ...
    Iterator<SearchEngineEntity<?>> searchEngines = engineRepository.findAll()
        .iterator();
