...
public class IPODServiceSOAPProxy implements
  ...
  private void _initIPODServiceSOAPProxy() {
    try {
      iPODServiceSOAP = (new org.tempuri.QueryServiceLocator())
          .getBasicHttpBinding_IPODServiceSOAP();
      if (iPODServiceSOAP != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub) iPODServiceSOAP)._setProperty(
              "javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String) ((javax.xml.rpc.Stub) iPODServiceSOAP)
