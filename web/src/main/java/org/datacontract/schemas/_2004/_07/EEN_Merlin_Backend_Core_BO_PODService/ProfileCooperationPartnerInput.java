...
public class ProfileCooperationPartnerInput implements java.io.Serializable {
   ...
   */
  public void setPartnershiptype(
      org.datacontract.schemas._2004._07.EEN_Merlin_Backend_Core_BO_PODService.ProfileCooperationPartnershipInput[] partnershiptype) {
    this.partnershiptype = partnershiptype;
  }
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof ProfileCooperationPartnerInput))
      return false;
    ...
    boolean _equals;
    _equals = true
        && ((this.partnershiptype == null && other.getPartnershiptype() == null) || (this.partnershiptype != null && java.util.Arrays
            .equals(this.partnershiptype, other.getPartnershiptype())))
        && ((this.sought == null && other.getSought() == null) || (this.sought != null && this.sought
            .equals(other.getSought())))
        && ((this.task == null && other.getTask() == null) || (this.task != null && java.util.Arrays
            .equals(this.task, other.getTask())));
    __equalsCalc = null;
    return _equals;
  }
  ...
  public synchronized int hashCode() {
    ...
    if (getPartnershiptype() != null) {
      for (int i = 0; i < java.lang.reflect.Array
          .getLength(getPartnershiptype()); i++) {
        java.lang.Object obj = java.lang.reflect.Array.get(
            getPartnershiptype(), i);
    ...
    if (getTask() != null) {
      for (int i = 0; i < java.lang.reflect.Array.getLength(getTask()); i++) {
  ...
  private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
      ProfileCooperationPartnerInput.class, true);
