...
public class QueryServiceLocator extends org.apache.axis.client.Service
    implements org.tempuri.QueryService {
  ...
  public void setBasicHttpBinding_IPODServiceSOAPWSDDServiceName(
  ...
  public eu.europa.ec.een.tools.services.soap.IPODServiceSOAP getBasicHttpBinding_IPODServiceSOAP(
    ...
    try {
      org.tempuri.BasicHttpBinding_IPODServiceSOAPStub _stub = new org.tempuri.BasicHttpBinding_IPODServiceSOAPStub(
          portAddress, this);
  ...
  public void setBasicHttpBinding_IPODServiceSOAPEndpointAddress(
  ...
  public java.rmi.Remote getPort(Class serviceEndpointInterface)
      throws javax.xml.rpc.ServiceException {
    try {
      if (eu.europa.ec.een.tools.services.soap.IPODServiceSOAP.class
          .isAssignableFrom(serviceEndpointInterface)) {
        org.tempuri.BasicHttpBinding_IPODServiceSOAPStub _stub = new org.tempuri.BasicHttpBinding_IPODServiceSOAPStub(
            new java.net.URL(BasicHttpBinding_IPODServiceSOAP_address), this);
        _stub.setPortName(getBasicHttpBinding_IPODServiceSOAPWSDDServiceName());
        return _stub;
      }
  ...
  public java.util.Iterator getPorts() {
    if (ports == null) {
      ...
      ports.add(new javax.xml.namespace.QName("http://tempuri.org/",
          "BasicHttpBinding_IPODServiceSOAP"));
    }
