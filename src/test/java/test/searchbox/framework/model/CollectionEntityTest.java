...
public class CollectionEntityTest {
  ...
  public void testBuildCollectionFactory(){
    CollectionEntity cf = new CollectionEntity().setClazz(DefaultCollection.class);
  ...
  public void testCustomCollectionBuild_Type(){
    CollectionEntity<MyCollection> cf = new CollectionEntity<MyCollection>().setClazz(MyCollection.class);
  ...
  public void testBeanFieldCopyInCollectionFactory(){
    ...
    Assert.assertEquals("Collection Name (bean Copy)", COLLECTION_NAME, my.getName());
  }
