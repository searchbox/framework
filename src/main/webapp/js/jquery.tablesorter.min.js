        ...
        tablesorter: new function() {
                        ...
                        if (!g)
                            a: {
                                ...
                                for (var A = f, k = void 0, m = e.parsers.length, t=!1, v = "", k=!0; "" === v && k;)
                                    g++, r[g] ? (t = r[g].cells[A], v = p(l, t, A), l.config.debug && c("Checking if value was empty on row " + g + ", column: " + A + ': "' + v + '"')) : k=!1;
                                    for (; 0<=--m;)
            ...
            function z(a) {
                ...
                for (n = 0; n < b.length; n++)
                    ...
                    for (r = 0; r < h; ++r)
                        ...
                        for (q = 0; q < y; ++q)
                            l = p(a, A[0].cells[q], q), l = f[q].format(l, a, A[0].cells[q], q), m.push(l), "numeric" === (f[q].type || "").toLowerCase() && (t[q] = Math.max(Math.abs(l) || 0, t[q] || 0));
            ...
            function B(a, b) {
                ...
                if (!m(f)) {
                    ...
                    for (t = 0; t < h.length; t++)
                        if (l = g(h[t]), l.length&&!l.hasClass(d.cssInfoBlock)
                            ) {
                        ...
                        for (p = 0; p < q; p++)
                            if (s = r[p][n], c.push(l[s])
                                , !d.appender ||!d.removeRows)for (v = l[s].length, w = 0; w < v; w++)
                            A.append(l[s][w]);
            ...
            function E(a) {
                ...
                for (f = 0; f < c.length; f++)
                    for (n = c[f].cells, l = 0; l < n.length; l++) {
                        q = n[l];
                ...
                for (b = 0; b < h; b++)
                    if (2 !== f[b][1] && (a = c.$headers.not(".sorter-false").filter('[data-column="' + f[b][0] + '"]' + (1 === h ? ":last" : "")), a.length))
                        for (d = 0; d < a.length; d++)
                            a[d].sortDisabled || (a.eq(d).addClass(l[f[b][1]]), r.length && r.filter('[data-column="' + f[b][0] + '"]').eq(d).addClass(l[f[b][1]]))
            }
            function L(a) {
            ...
            function N(a, b, d) {
                ...
                else if (h = b.order[b.count], 2 > h && (f.sortList.push([c, h])
            ...
            function I(a) {
                ...
                if (!s.serverSideSorting && !m(s.cache)) {
                    s.debug && (p = new Date);
                    for (d = 0; d < C; d++)
                        l = s.cache[d].colMax, n = (g = s.cache[d].normalized) && g[0] ? g[0].length-1 : 0, g.sort(function(d, g) {
                        for (b = 0; b < B; b++) {
                            f = z[b][0];
                            q = z[b][1];
                            w = (v = 0 === q) ? d : g;
            ...
            e.refreshWidgets = function(a, b, d) {
                ...
                for (h = 0; h < m; h++)
                    l[h] && l[h].id && (b || 0 > g.inArray(l[h].id, f)) && (k.debug && c("Refeshing widgets: Removing " + l[h].id), l[h].hasOwnProperty("remove") && (l[h].remove(a, k, k.widgetOptions), k.widgetInit[l[h].id]=!1));
    ...
    p.addWidget({
        ...
        remove: function(c, k, m) {
            ...
            for (m = 0; m < k.length; m++)
                p = g.tablesorter.processTbody(c, k.eq(m), !0), p.children().removeClass(x), g.tablesorter.processTbody(c, p, !1)
        }
    })
})(jQuery);
