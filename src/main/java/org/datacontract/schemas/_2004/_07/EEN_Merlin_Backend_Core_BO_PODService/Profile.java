...
public class Profile implements java.io.Serializable {
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    ...
    _equals = true
        ...
        && ((this.customprops == null && other.getCustomprops() == null) || (this.customprops != null && this.customprops
            .equals(other.getCustomprops())))
        && ((this.datum == null && other.getDatum() == null) || (this.datum != null && this.datum
            .equals(other.getDatum())))
        ...
        && ((this.partnerships == null && other.getPartnerships() == null) || (this.partnerships != null && java.util.Arrays
            .equals(this.partnerships, other.getPartnerships())))
  ...
  public synchronized int hashCode() {
    ...
    if (getPartnerships() != null) {
      for (int i = 0; i < java.lang.reflect.Array.getLength(getPartnerships()); i++) {
        java.lang.Object obj = java.lang.reflect.Array
            .get(getPartnerships(), i);
        if (obj != null && !obj.getClass().isArray()) {
          _hashCode += obj.hashCode();
        }
      }
