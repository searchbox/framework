...
public class ProfileCooperationInput implements java.io.Serializable {
  ...
  public ProfileCooperationInput(
      ...
      java.lang.String stagedevcomments, java.lang.String techspec) {
    this.advino = advino;
    this.ipr = ipr;
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof ProfileCooperationInput))
      return false;
    ...
    boolean _equals;
    _equals = true
        && ((this.advino == null && other.getAdvino() == null) || (this.advino != null && this.advino
            .equals(other.getAdvino())))
        && ((this.ipr == null && other.getIpr() == null) || (this.ipr != null && java.util.Arrays
            .equals(this.ipr, other.getIpr())))
        && ((this.iprcomments == null && other.getIprcomments() == null) || (this.iprcomments != null && this.iprcomments
            .equals(other.getIprcomments())))
        && ((this.partner == null && other.getPartner() == null) || (this.partner != null && this.partner
            .equals(other.getPartner())))
        && ((this.profileorigin == null && other.getProfileorigin() == null) || (this.profileorigin != null && this.profileorigin
            .equals(other.getProfileorigin())))
        && ((this.stagedev == null && other.getStagedev() == null) || (this.stagedev != null && this.stagedev
            .equals(other.getStagedev())))
        && ((this.stagedevcomments == null && other.getStagedevcomments() == null) || (this.stagedevcomments != null && this.stagedevcomments
            .equals(other.getStagedevcomments())))
        && ((this.techspec == null && other.getTechspec() == null) || (this.techspec != null && this.techspec
            .equals(other.getTechspec())));
    __equalsCalc = null;
    return _equals;
  }
  ...
  public synchronized int hashCode() {
    ...
    if (getIpr() != null) {
      for (int i = 0; i < java.lang.reflect.Array.getLength(getIpr()); i++) {
  ...
  private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
      ProfileCooperationInput.class, true);
