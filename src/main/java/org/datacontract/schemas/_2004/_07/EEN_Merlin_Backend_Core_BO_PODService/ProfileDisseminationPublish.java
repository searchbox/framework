...
public class ProfileDisseminationPublish  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProfileDisseminationPublish)) return false;
        ...
        _equals = true && 
            ((this.sectorgroup==null && other.getSectorgroup()==null) || 
             (this.sectorgroup!=null &&
              java.util.Arrays.equals(this.sectorgroup, other.getSectorgroup())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSectorgroup() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSectorgroup());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProfileDisseminationPublish.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/EEN.Merlin.Backend.Core.BO.PODService", "profileDisseminationPublish"));
