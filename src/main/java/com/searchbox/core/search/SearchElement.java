...
public abstract class SearchElement implements Comparable<SearchElement> {
  ...
  public URL getView() {
    ...
    System.out.println("XOXOXOXOXOX: "
        + this.getClass().getResource("view.jspx"));
  ...
  public static class Converter
    ...
    public Condition convert(String source) {
      ...
      LOGGER
          .error("please make sure to define a \"public static final String URL_PARAM = ...\" ");
      LOGGER
          .error("within your SearchElement class. That URL_PARAM is used on forms (jspx) as");
      ...
      LOGGER
          .error("public static class Converter implements org.spring...Converter<String, MyOwnSearchElement> {");
      return null;
    }
  }
}
