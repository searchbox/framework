...
public class FieldAttributeDefinition extends UnknownClassDefinition implements
        ElementFactory<FieldAttribute> {
    ...
    public FieldAttribute getInstance() {
        ...
        attribute
                .setField(new Field(this.field.getClazz(), this.field.getKey()));
