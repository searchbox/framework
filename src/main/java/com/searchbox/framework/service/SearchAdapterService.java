...
public class SearchAdapterService implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        for (Entry<String, Object> bean : context.getBeansWithAnnotation(
            ...
            for (Method method : adapter.getClass().getDeclaredMethods()) {
                SearchAdapter.Time t = method.getAnnotation(
                        SearchAdapterMethod.class).execute();
                LOGGER.debug("Registering adapter " + t + "\t-- "
                        + method.getName());
    ...
    public void doAdapt(SearchAdapter.Time time, Class<?> requiredArg,
        ...
        this.doAdapt(requiredArg, this.searchAdapterMethods.get(time),
                arguments);
    }
            ...
            if (currentObject != null) {
                if (Collection.class.isAssignableFrom(currentObject.getClass())) {
                    ...
                    if (!map.containsKey(currentObject.getClass())) {
                        map.put(currentObject.getClass(),
    ...
    private void executeMethod(Object caller, Method method,
            Object... arguments) {
        try {
