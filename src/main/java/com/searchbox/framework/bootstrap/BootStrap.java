...
//                                .getPath());
            ...
            FieldAttributeDefinition fieldAttr3 = new FieldAttributeDefinition(
                    collection.getFieldDefinition("article-completion-date"));
            ...
            FieldAttributeDefinition fieldAttr4 = new FieldAttributeDefinition(
                    collection.getFieldDefinition("article-revision-date"));
            ...
            viewHit.setAttributeValue("template",
                    "Now we have a template dedicated to the view here...");
            ...
            /**
             * this is a simple hitlist with no templates Create & add a HitLIst
             * SearchComponent to the preset; SearchElementDefinition hitList =
             * new SearchElementDefinition(HitList.class);
             ...
             * fields.add("article-abstract"); fields.add("author");
            ...
            SearchElementDefinition fieldFacet = new SearchElementDefinition(
                    FieldFacet.class);
            fieldFacet.setAttributeValue("field",
                    Field.stringField("publication-type"));
